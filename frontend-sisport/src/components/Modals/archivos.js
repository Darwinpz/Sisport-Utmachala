...
export default function Archivos() {
    ...
    const EliminarSubmit = () => {
        ...
        eliminarArchivo({ fac_abreviatura, car_abreviatura, asig_abreviatura: identificador + "-" + peri_codigo + "-" + sem_codigo, per_cedula, tipo_archivo, nombre_archivo }).then(() => {
    ...
    const DescargarSubmit = () => {
        ...
        descargarArchivo({ fac_abreviatura, car_abreviatura, asig_abreviatura: identificador + "-" + peri_codigo + "-" + sem_codigo, per_cedula: cedula, tipo_archivo, nombre_archivo }).then((url) => {
