...
def uploadSyllabus(request, lista_extensions):
    try:
        if request.method == 'POST':
            ...
            asig_identificador = seperator.join(
                request.values.getlist('asig_identificador'))
            per_cedula = seperator.join(request.values.getlist('per_cedula'))

            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/2. Elementos curriculares/a. Syllabus/')
...
def uploadEvaluacion(request, lista_extensions):
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/2. Elementos curriculares/d. Evaluaciones/')
...
def uploadInvestigacion(request, lista_extensions):
    ...
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/2. Elementos curriculares/e. Investigaciones/')
...
def uploadActividad(request, lista_extensions):
    ...
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador+'/Portafolios/' +
                    per_cedula+'/2. Elementos curriculares/f. Actividades de experimentación/')
...
def uploadProyecto(request, lista_extensions):
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/2. Elementos curriculares/g. Proyectos/')
...
def uploadCasoEstudio(request, lista_extensions):
    ...
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/2. Elementos curriculares/h. Estudios de caso/')
...
def uploadPlanteamiento(request, lista_extensions):
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador+'/Portafolios/' +
                    per_cedula+'/2. Elementos curriculares/i. Planteamiento de problemas/')
...
def uploadAsistencia(request, lista_extensions):
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/2. Elementos curriculares/j. Registro de asistencia/')
...
def uploadObservacion(request, lista_extensions):
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador+'/Portafolios/' +
                    per_cedula+'/2. Elementos curriculares/k. Registro de observaciones/')
...
def uploadIntraclase(request, lista_extensions):
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/2. Elementos curriculares/l. Tareas intraclases/')
...
def uploadAutonomo(request, lista_extensions):
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/2. Elementos curriculares/m. Tareas autónomas/')
...
def uploadRefuerzo(request, lista_extensions):
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/2. Elementos curriculares/n. Tareas de refuerzo/')
...
def uploadBiografia(request, lista_extensions):
    try:
        if request.method == 'POST':
            ...
            ruta = ('resources/'+fac_nombre+'/'+car_nombre+'/'+asig_identificador +
                    '/Portafolios/'+per_cedula+'/1. Datos informativos/')
...
def eliminarArchivo(request):
    ...
    try:
        ...
        ruta = ('resources/'+fac_abreviatura+'/'+car_abreviatura+'/' +
                asig_abreviatura + '/Portafolios/'+per_cedula+'/2. Elementos curriculares/')
        ...
        if(tipo_archivo == 'syllabus'):
            ...
            ruta_archivo = (
                ruta+"f. Actividades de experimentación/"+nombre_archivo)
